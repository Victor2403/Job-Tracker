...
function App() {
  ...
  return (
    ...
    {/* Analytics Dashboard - FIXED 2-COLUMN LAYOUT */}
        <div className="max-w-7xl mx-auto mb-12">
          <h2 className="text-3xl font-bold text-white mb-8">📊 Advanced Analytics Dashboard</h2>
          
          {/* TOP ROW: Pie Chart + Quick Stats (Already Working) */}
          ...
          {/* MIDDLE ROW: Application Funnel + Top Companies - 2 COLUMNS */}
          <div className="analytics-grid mb-8">
            {/* Application Funnel */}
            <div className="glass-card rounded-xl p-6">
          ...
          {/* BOTTOM ROW: Skills Gap + Monthly Trends - 2 COLUMNS */}
          <div className="analytics-grid mb-8">
            {/* Skills Gap Analysis */}
            <div className="glass-card rounded-xl p-6">
